...
public class HudiInputBase extends HiveInputBase {
    ...
    protected static AbstractExecutable createFlatHiveTableBySparkSql(String hiveInitStatement,
                                                                      String jobWorkingDir, String cubeName,IJoinedFlatTableDesc joinedFlatTableDesc){
        SparkExecutable sparkExecutable =(SparkExecutable)HiveInputBase.createFlatHiveTableBySparkSql(hiveInitStatement,jobWorkingDir,cubeName,joinedFlatTableDesc);
        sparkExecutable.setParam("spark.sql.hive.convertMetastoreParquet","false");
